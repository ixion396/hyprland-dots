...
interface Widget {
  ...
  toggleClassName(name: string, enable: boolean): void;
}
...
declare module 'resource:///com/github/Aylur/ags/widget.js' {
  ...
  type ShortLabelType = Widget & string;
  export function Label(args: Partial<LabelArgs> | string): LabelType | ShortLabelType;
