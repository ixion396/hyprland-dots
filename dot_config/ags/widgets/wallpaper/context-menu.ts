...
const layerItem = (name: string, icon: string, command: string) => EventBox({
...
const layer = (items: Widget[], marginFromTop: number) => Box({
...
const contextMenuItem = (name: string, icon: string, cmd: string) => EventBox({
    className: "context-menu-item",
